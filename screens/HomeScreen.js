...

        {
          loading? (
            ...
            <SafeAreaView className="flex flex-1">
              {/*search section*/}
              <View style={{height: '7%', top: '7%'}} className="mx-4 relative z-50">
              ...
              {/* forecast section */}
              <View className="mx-4 flex justify-around flex-1 mb-20 top-16">
                    {/* location */}
                    <Text className="text-white text-center text-3xl font-bold">
                      {location?.name},
                      <Text className="font-semibold text-2xl text-gray-300">
                        {" "+location?.country}
                      </Text>
                    </Text>
                    {/* weather image */}
              ...
              <View className="mb-2 space-y-3 bottom-2">
...

                      {
                        weather?.forecast?.forecastday?.map((item, index) => {
                          ...
                          return (
                            <View
                              key={index}
                              className="flex justify-center items-center w-24 rounded-3xl py-3 space-y-2 mr-4"
